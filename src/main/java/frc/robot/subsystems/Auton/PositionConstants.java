...
public class PositionConstants {
    ...
    public class GamePeice {
        public static final Pose2d BlueC1 = new Pose2d(2.2, 5.9, towardAlliance);
        public static final Pose2d BlueC2 = new Pose2d(2.2, 4.075, towardAlliance);
        public static final Pose2d BlueC3 = new Pose2d(2.2, 2.229, towardAlliance);
    ...
    public class Reef {
        ...
        public static final Pose2d BlueR6A = FlippingUtil.flipFieldPose(new Pose2d(14.42, 4.225, towardAlliance)); // la crosse
        public static final Pose2d BlueR6B = FlippingUtil.flipFieldPose(new Pose2d(14.42, 4.034, towardAlliance));
        ...
        public static final Pose2d PreBlueR8A = BlueR6A.rotateAround(ReefCenter, Rotation2d.fromDegrees(-60));
        public static final Pose2d PreBlueR8B = BlueR6B.rotateAround(ReefCenter, Rotation2d.fromDegrees(-60));
        public static final Pose2d PreBlueR4A = BlueR6A.rotateAround(ReefCenter, Rotation2d.fromDegrees(60));
        public static final Pose2d PreBlueR4B = BlueR6B.rotateAround(ReefCenter, Rotation2d.fromDegrees(60));
        public static final Pose2d PreBlueR10A = BlueR6A.rotateAround(ReefCenter, Rotation2d.fromDegrees(-120));
        public static final Pose2d PreBlueR10B = BlueR6B.rotateAround(ReefCenter, Rotation2d.fromDegrees(-120));
        public static final Pose2d PreBlueR12A = BlueR6A.rotateAround(ReefCenter, Rotation2d.fromDegrees(180));
        public static final Pose2d PreBlueR12B = BlueR6B.rotateAround(ReefCenter, Rotation2d.fromDegrees(180));
        public static final Pose2d PreBlueR2A = BlueR6A.rotateAround(ReefCenter, Rotation2d.fromDegrees(120));
        public static final Pose2d PreBlueR2B = BlueR6B.rotateAround(ReefCenter, Rotation2d.fromDegrees(120));
        ...
        public static Pose2d poseToPreAlign(Pose2d pose){
            return pose.plus(new Transform2d(new Translation2d(-1, 0), Rotation2d.fromDegrees(0)));
        }
    }
