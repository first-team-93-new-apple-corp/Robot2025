...
public class Telemetry {
    ...
    private final DoubleArrayPublisher coralPub = table.getDoubleArrayTopic("coralPose").publish();
    ...
    public void publishCoralPose2D(Pose2d pose) {
        double[] coralPoseArray = new double[3];
        coralPoseArray[0] = pose.getX();
        coralPoseArray[1] = pose.getY();
        coralPoseArray[2] = pose.getRotation().getDegrees();
        coralPub.set(coralPoseArray);
    }
}